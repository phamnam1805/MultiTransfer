...
async function main() {
    ...
    await erc20.approve(multiTransfer.address, ethers.utils.parseEther(totalAmount.toString()));
    await multiTransfer.multiTransfer(erc20.address, listAddresses, listAmounts);
